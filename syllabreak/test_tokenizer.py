import pytest
from syllabreak.tokenizer import Tokenizer, TokenClass
...
def test_separator(create_test_rule):
    ...
    assert classes == [TokenClass.VOWEL, TokenClass.CONSONANT, TokenClass.SEPARATOR, 
                       TokenClass.CONSONANT, TokenClass.CONSONANT]
